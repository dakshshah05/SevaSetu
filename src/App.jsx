...
export default function App() {
  ...
  // Temporary States for quick dialog actions
  ...
  useEffect(() => {
    ...
    // 2. Real-time collections subscriptions
  ...
  const handleFoodCompleteSubmit = async (e) => {
    ...
    try {
      ...
      triggerToast("Distribution verified! Points allocated to restaurant & volunteer.");
  ...
  const handleJoinDriveClick = async (id) => {
    try {
      ...
      triggerToast("Joined campaign squad! Let's clean.");
    } catch (err) {
      triggerToast(err.message, true);
    }
  };
  ...
  // Module 6: Donations & Crowdfunding (New)
  ...
  const handleSOSBroadcastSubmit = async (e) => {
    ...
    try {
      ...
      triggerToast("SOS broadcasted to all nearby volunteers!", true);
      setSosModal(false);
  ...
  const handleClaimMedClick = async (id) => {
    try {
      ...
      triggerToast("Medicine surplus claimed for free medical camp.");
    } catch (err) {
      triggerToast(err.message, true);
    }
  };
      ...
      <aside className="sidebar">
        ...
        <nav>
          <ul class="nav-links">
            ...
            <li onClick={() => setActiveView("food-waste")}>
              <div className={`nav-item ${activeView === "food-waste" ? "active" : ""}`}>
                <Utensils />
                <span>Ahaar Setu</span>
              </div>
            </li>
            <li onClick={() => setActiveView("cleanup-drives")}>
              <div className={`nav-item ${activeView === "cleanup-drives" ? "active" : ""}`}>
                <Trash2 />
                <span>Swachh Setu</span>
              </div>
            </li>
            <li onClick={() => setActiveView("ngo-admin")}>
              <div className={`nav-item ${activeView === "ngo-admin" ? "active" : ""}`}>
                <Building />
                <span>Sahaayak Setu</span>
              </div>
            </li>
            <li onClick={() => setActiveView("skills")}>
              <div className={`nav-item ${activeView === "skills" ? "active" : ""}`}>
                <Briefcase />
                <span>Seva Tasks</span>
              </div>
            </li>
            <li onClick={() => setActiveView("crowd")}>
              <div className={`nav-item ${activeView === "crowd" ? "active" : ""}`}>
                <Heart />
                <span>Crowdfund</span>
              </div>
            </li>
            <li onClick={() => setActiveView("sos")}>
              <div className={`nav-item ${activeView === "sos" ? "active" : ""}`}>
                <ShieldAlert />
                <span>Emergency SOS</span>
                {activeSOS.length > 0 && (
                  <span style={{ backgroundColor: "var(--color-danger)", color: "white", borderRadius: "50%", padding: "2px 6px", fontSize: "10px", fontWeight: "bold", marginLeft: "auto" }}>
                    {activeSOS.length}
                  </span>
                )}
              </div>
            </li>
            <li onClick={() => setActiveView("meds")}>
              <div className={`nav-item ${activeView === "meds" ? "active" : ""}`}>
                <Pill />
                <span>Medicine Pool</span>
              </div>
            </li>
            <li onClick={() => setActiveView("rewards-store")}>
              <div className={`nav-item ${activeView === "rewards-store" ? "active" : ""}`}>
                <Gift />
                <span>Seva Store</span>
              </div>
            </li>
          </ul>
        </nav>
        ...
        {user ? (
          <div className="user-sidebar-profile">
            ...
            {user.role === "volunteer" && (
              <div className="user-points-badge" style={{ backgroundColor: "rgba(249, 115, 22, 0.12)", color: "var(--color-orange)" }}>
                <Award size={14} />
                <span>{user.rewardPoints || 0} Pts</span>
              </div>
            )}
            {user.role === "restaurant" && (
              <div className="user-points-badge" style={{ backgroundColor: "rgba(0, 245, 212, 0.12)", color: "var(--color-teal)" }}>
                <Award size={14} />
          ...
          <div className="user-sidebar-profile" style={{ textAlign: "center", cursor: "pointer", background: "rgba(139, 92, 246, 0.1)" }} onClick={() => { setAuthModal(true); setAuthTab("login"); }}>
            <span style={{ fontSize: "13px", fontWeight: "600", color: "#c084fc", display: "flex", alignItems: "center", justifyContent: "center", gap: "8px" }}>
              <LogIn size={16} /> Sign In to System
            </span>
          </div>
        )}
      </aside>
      ...
      <main className="main-content">
        <header className="content-header">
          <div className="header-title-area">
            <h1>
              ...
              {activeView === "meds" && "Surplus Medicine Redistribution"}
              {activeView === "rewards-store" && "Seva Reward Store"}
            </h1>
            <p>
          ...
          <div className="header-actions">
            {!user ? (
              <div className="header-actions">
                <button className="btn btn-outline" onClick={() => { setAuthModal(true); setAuthTab("login"); }}>
                  <LogIn size={16} /> Login
                </button>
                <button className="btn btn-primary" onClick={() => { setAuthModal(true); setAuthTab("register"); }}>
        ...
        {activeView === "dashboard" && (
          <section className="module-panel gsap-reveal">
            ...
            <div className="dashboard-columns">
              {/* Mission Statement & Features overview */}
              <div className="card card-teal">
                <div className="info-header">
                  <h3>Connecting Hearts, Empowering Civic Drives</h3>
                </div>
                <p style={{ lineHeight: "1.6", color: "var(--text-sub)", marginBottom: "20px" }}>
                ...
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "20px", marginTop: "10px" }}>
                  <div style={{ background: "rgba(255,255,255,0.01)", padding: "16px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-glass)" }}>
                    <h4 style={{ color: "var(--color-teal)", marginBottom: "8px" }}><Sparkles size={16} /> Real-Time Live Sync</h4>
                    <p style={{ fontSize: "12px", color: "var(--text-sub)" }}>Fully bound to live Firestore. Feeds update instantly as users post actions.</p>
                  </div>
                  <div style={{ background: "rgba(255,255,255,0.01)", padding: "16px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-glass)" }}>
                    <h4 style={{ color: "#c084fc", marginBottom: "8px" }}><Coins size={16} /> Volunteering Points</h4>
                    <p style={{ fontSize: "12px", color: "var(--text-sub)" }}>Every claimed food delivery, drive completion, or task approval rewards you points.</p>
                  </div>
                </div>
              </div>
                ...
                <div className="leaderboard-list">
                  {activeLeaderboardTab === "volunteers" ? (
                    volunteerLeaderboard.length === 0 ? (
                      <p style={{ color: "var(--text-sub)", textAlign: "center", padding: "20px" }}>No volunteers recorded.</p>
                    ) : (
                        ...
                        <div key={v.uid} className={`leaderboard-item rank-${idx+1}`}>
                          <div className="leaderboard-item-info">
                            ...
                            <div>
                              ...
                              <span style={{ fontSize: "10px", color: "var(--text-sub)" }}>{v.completedCount || 0} achievements</span>
                            </div>
                          </div>
                    ...
                    restaurantLeaderboard.length === 0 ? (
                      <p style={{ color: "var(--text-sub)", textAlign: "center", padding: "20px" }}>No restaurants recorded.</p>
                    ) : (
                      restaurantLeaderboard.slice(0, 5).map((r, idx) => (
                        <div key={r.uid} className={`leaderboard-item rank-${idx+1}`}>
                          <div className="leaderboard-item-info">
                            <span className="leaderboard-rank">{idx + 1}</span>
                            <div className="user-avatar" style={{ width: "30px", height: "30px", fontSize: "12px", borderColor: "var(--color-orange)", color: "var(--color-orange)" }}>{r.name.charAt(0).toUpperCase()}</div>
                            <div>
                              <h5 style={{ fontSize: "13px" }}>{r.name}</h5>
                              <span style={{ fontSize: "10px", color: "var(--text-sub)" }}>{r.address ? r.address.split(",")[0] : "Local"}</span>
                            </div>
                          </div>
        ...
        {activeView === "food-waste" && (
          <section className="module-panel gsap-reveal">
            <div style={{ display: "grid", gridTemplateColumns: "1fr 2fr", gap: "32px" }}>
              {/* Form to submit food waste */}
              <div className="card card-teal" style={{ height: "max-content" }}>
                <h3>Report Surplus Food</h3>
                <p style={{ color: "var(--text-sub)", fontSize: "13px", margin: "6px 0 20px 0" }}>Share details of surplus food so nearby volunteers are alerted.</p>
                {user?.role === "restaurant" ? (
                  <form onSubmit={handleFoodPostSubmit}>
                    ...
                    <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Plus size={16} /> Broadcast Food Alert</button>
                  </form>
                ) : (
                  <div style={{ textAlign: "center", padding: "30px 0" }}>
                    <Utensils style={{ width: "36px", height: "36px", color: "var(--text-muted)", marginBottom: "12px" }} />
                    <p style={{ fontSize: "13px", color: "var(--text-sub)" }}>Please sign in as a <strong>Restaurant</strong> to register food waste alerts.</p>
                  </div>
                )}
              </div>
              ...
              <div className="card card-teal">
                ...
                <div className="card-deck">
                  {foods.filter(f => activeFoodTab === "all" ? (f.status === "pending" || (user && f.claimedBy === user.uid)) : (user && f.claimedBy === user.uid)).length === 0 ? (
                    <p style={{ color: "var(--text-muted)", gridColumn: "1/-1", textAlign: "center", padding: "40px" }}>No active food pickup coordinates found.</p>
                  ) : (
                      ...
                      return (
                        <div key={f.id} className={`card pickup-card ${f.status === "completed" ? "card-teal" : f.status === "claimed" ? "card-violet" : "card-orange"}`} style={{ padding: "20px" }}>
                          ...
                          <div className="pickup-details" style={{ flexGrow: 1, marginTop: "12px" }}>
                            ...
                            <div className="pickup-details-row">
                              <Clock />
                              <span style={isExpired && f.status === "pending" ? { color: "var(--color-danger)", fontWeight: "bold" } : {}}>
                            ...
                            {f.feedback && (
                              <p style={{ padding: "8px", background: "rgba(255,255,255,0.02)", border: "1px dashed var(--border-glass)", borderRadius: "var(--radius-sm)", fontSize: "11px", fontStyle: "italic", color: "var(--color-teal)" }}>
                                "{f.feedback}"
                              </p>
                            )}
                          </div>
                          ...
                          {f.status === "pending" && user?.role === "volunteer" && (
                            <button className="btn btn-teal" onClick={() => handleClaimFoodClick(f.id)} style={{ width: "100%", marginTop: "12px" }}><Check size={14} /> Claim Pickup</button>
                          )}
                          {f.status === "claimed" && user?.uid === f.claimedBy && (
                            <button className="btn btn-orange" onClick={() => { setSelectedFoodId(f.id); setFoodCompleteModal(true); }} style={{ width: "100%", marginTop: "12px" }}><Activity size={14} /> Complete Delivery</button>
                          )}
                        </div>
                      );
                    })
        ...
        {activeView === "cleanup-drives" && (
          <section className="module-panel gsap-reveal">
            ...
            <div className="card-deck">
              {drives.length === 0 ? (
                <p style={{ color: "var(--text-muted)", gridColumn: "1/-1", textAlign: "center", padding: "40px" }}>No scheduled cleanup drives found.</p>
              ) : (
                drives.map(d => {
                  ...
                  return (
                    <div key={d.id} className="card card-violet" style={{ display: "flex", flexDirection: "column", minHeight: "320px" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "10px", marginBottom: "12px" }}>
                        <h4 style={{ fontSize: "18px" }}>{d.title}</h4>
                        <span className="user-points-badge" style={{ color: "var(--color-teal)", borderColor: "rgba(0, 245, 212, 0.3)", backgroundColor: "rgba(0, 245, 212, 0.08)", fontSize: "11px" }}>
                          +{d.pointsReward} Pts
                        </span>
                      </div>
                      <p style={{ fontSize: "13px", color: "var(--text-sub)", lineHeight: "1.5", flexGrow: 1, marginBottom: "16px" }}>{d.description}</p>
                      ...
                      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid var(--border-glass)", paddingTop: "12px" }}>
                        <span style={{ fontSize: "12px", color: "var(--text-sub)" }}>{d.participants.length} joined</span>
                        {user?.role === "volunteer" && (
                          !hasJoined ? (
                            ...
                            isApproved ? (
                              <span style={{ color: "var(--color-teal)", fontSize: "12px", fontWeight: "bold" }}><Check size={14} /> Points Awarded</span>
                            ) : hasSubmitted ? (
                              <span style={{ color: "var(--text-sub)", fontSize: "12px", fontStyle: "italic" }}>Review Pending</span>
                            ) : (
        ...
        {activeView === "ngo-admin" && (
          <section className="module-panel gsap-reveal">
            {user?.role === "ngo" ? (
                ...
                {activeNgoTab === "roster" ? (
                  <div className="leaderboard-list">
                    {leaderboard.volunteers.filter(v => v.ngoId === user.uid).length === 0 ? (
                      <p style={{ color: "var(--text-muted)", textAlign: "center", padding: "30px" }}>No registered volunteers in your roster yet.</p>
                    ) : (
                      leaderboard.volunteers.filter(v => v.ngoId === user.uid).map((v, idx) => (
                        <div key={v.uid} className="leaderboard-item">
                          <div className="leaderboard-item-info">
                            ...
                            <div>
                              <h5 style={{ fontSize: "13px" }}>{v.name}</h5>
                              <span style={{ fontSize: "10px", color: "var(--text-sub)" }}>{v.impactHours || 0} volunteering hours log</span>
                            </div>
                          </div>
                          <span className="leaderboard-points">{v.rewardPoints || 0} Pts</span>
                        </div>
                  ...
                  <div className="leaderboard-list" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(280px, 1fr))", gap: "20px" }}>
                    {drives.filter(d => d.organizerId === user.uid && d.proofs.some(p => !p.approved)).length === 0 ? (
                      <p style={{ color: "var(--text-muted)", textAlign: "center", padding: "30px", gridColumn: "1/-1" }}>No work completion proofs awaiting review.</p>
                    ) : (
                      drives.filter(d => d.organizerId === user.uid).flatMap(d => 
                        d.proofs.filter(p => !p.approved).map(p => (
                          <div key={d.id + "_" + p.volunteerId} className="card card-violet" style={{ padding: "16px", display: "flex", flexDirection: "column", gap: "12px" }}>
                            ...
                            <span style={{ fontSize: "11px", color: "var(--text-sub)" }}>Campaign: <strong>{d.title}</strong></span>
                            
                            <img src={p.imageUrl} style={{ width: "100%", height: "130px", objectFit: "cover", borderRadius: "var(--radius-sm)", border: "1px solid var(--border-glass)" }} onerror={(e)=>{e.target.src="https://images.unsplash.com/photo-1611284446314-60a58ac0deb9?w=300"}} />

                            <button className="btn btn-teal" onClick={() => handleApproveProofClick(d.id, p.volunteerId)} style={{ width: "100%", padding: "8px 12px", fontSize: "12px" }}><Check size={12} /> Approve Work</button>
                          </div>
                        ))
                      )
                    )}
              ...
              // Citizen Directory view
              <div className="card card-violet">
                <h3>Explore Verified Partner NGOs</h3>
                <p style={{ color: "var(--text-sub)", fontSize: "14px", margin: "6px 0 24px 0" }}>Apply to join NGO cohorts to participate in their coordinated relief campaigns.</p>
                
                <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))", gap: "24px" }}>
                  {leaderboard.volunteers.length === 0 ? (
                    <p style={{ color: "var(--text-sub)", gridColumn: "1/-1", textAlign: "center" }}>Loading NGO lists...</p>
                  ) : (
                    // Simulating NGO directory listings
                    [
                        ...
                        <div key={n.uid} className={`card ${isJoined ? "card-violet" : ""}`} style={{ padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-between", gap: "16px" }}>
                          <div>
                            <div style={{ display: "flex", gap: "12px", alignItems: "center", marginBottom: "12px" }}>
                              <div className="logo-icon" style={{ width: "36px", height: "36px", fontSize: "16px", borderRadius: "8px" }}>N</div>
                              <div>
                                <h4 style={{ fontSize: "16px" }}>{n.name}</h4>
                                <span style={{ fontSize: "11px", color: "var(--text-sub)" }}>{n.members} active squad members</span>
                              </div>
                            </div>
                            <p style={{ fontSize: "13px", color: "var(--text-sub)", lineHeight: "1.5" }}>{n.description}</p>
                          </div>
        ...
        {activeView === "skills" && (
          <section className="module-panel gsap-reveal">
            <div className="content-header" style={{ padding: 0 }}>
              ...
              {user?.role === "ngo" && (
                <button className="btn btn-teal" onClick={() => setSkillModal(true)}><Plus size={16} /> Post a Task</button>
              )}
            </div>
            ...
            <div className="card-deck">
              {skills.filter(t => skillTaskFilter === "all" ? true : (user && t.assignedTo === user.uid)).length === 0 ? (
                <p style={{ color: "var(--text-muted)", gridColumn: "1/-1", textAlign: "center", padding: "40px" }}>No skill-based tasks published.</p>
              ) : (
                  ...
                  return (
                    <div key={t.id} className={`card ${isCompleted ? "card-teal" : isAssigned ? "card-purple" : "card-orange"}`} style={{ display: "flex", flexDirection: "column", minHeight: "300px" }}>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "10px", marginBottom: "12px" }}>
                        ...
                        <span className="badge badge-pending" style={{ backgroundColor: "rgba(13,148,136,0.12)", color: "var(--color-teal)", borderColor: "rgba(13,148,136,0.3)" }}>
                          {t.requiredSkill}
                        </span>
                      </div>
                      <p style={{ fontSize: "13px", color: "var(--text-sub)", lineHeight: "1.5", flexGrow: 1, marginBottom: "16px" }}>{t.description}</p>
                      ...
                      {t.status === "open" && user?.role === "volunteer" && (
                        <button className="btn btn-teal" onClick={() => handleApplySkillClick(t.id)} style={{ width: "100%" }}>Apply to Work</button>
                      )}
                      ...
                      {isCompleted && (
                        <div style={{ padding: "8px", background: "rgba(255,255,255,0.02)", border: "1px dashed var(--border-glass)", borderRadius: "var(--radius-sm)", fontSize: "11px" }}>
                          <span><FileCode style={{ display: "inline", width: "12px", height: "12px", marginRight: "4px" }} /> Work link: <a href={t.workLink} target="_blank" style={{ color: "var(--color-teal)" }}>{t.workLink.substring(0, 24)}...</a></span>
                        </div>
                      )}
                    </div>
                  );
        ...
        {activeView === "crowd" && (
          <section className="module-panel gsap-reveal">
            ...
            <div className="card-deck" style={{ gridTemplateColumns: "repeat(auto-fill, minmax(320px, 1fr))" }}>
              {crowd.length === 0 ? (
                <p style={{ color: "var(--text-muted)", gridColumn: "1/-1", textAlign: "center", padding: "40px" }}>No crowdfunding drives active.</p>
              ) : (
                crowd.map(c => {
                  ...
                  return (
                    <div key={c.id} className="card card-teal" style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                      <div>
                        <h4 style={{ fontSize: "18px", color: "white" }}>{c.title}</h4>
                        <span style={{ fontSize: "11px", color: "var(--text-sub)" }}>Organized by <strong>{c.organizerName}</strong></span>
                      </div>
                      <p style={{ fontSize: "13px", color: "var(--text-sub)", lineHeight: "1.5" }}>{c.description}</p>
                      
                      {/* Funding Progress Bar */}
                      <div>
                        <div style={{ display: "flex", justifyContent: "space-between", fontSize: "12px", fontWeight: "600", marginBottom: "4px" }}>
                          <span>₹{c.currentAmount.toLocaleString()} Raised</span>
                          <span style={{ color: "var(--color-teal)" }}>{percent}% (Target: ₹{c.targetAmount.toLocaleString()})</span>
                        </div>
                      ...
                      <div style={{ borderTop: "1px solid var(--border-glass)", paddingTop: "14px", marginTop: "4px" }}>
                        <div style={{ display: "flex", gap: "10px", marginBottom: "14px" }}>
                          ...
                          <button className="btn btn-teal" style={{ padding: "8px 16px", fontSize: "13px" }} onClick={() => handleDonateSubmit(c.id)}>Donate</button>
                        </div>

                        {/* NGO Proof upload toggle */}
                        {isOrganizer && (
                      ...
                      {c.proofs && c.proofs.length > 0 && (
                        <div style={{ background: "rgba(255,255,255,0.02)", padding: "12px", borderRadius: "var(--radius-md)", border: "1px solid var(--border-glass)" }}>
                          <h5 style={{ fontSize: "12px", color: "var(--color-teal)", marginBottom: "8px" }}><Sparkles size={12} /> Live Proof Timeline</h5>
                          {c.proofs.map((pr, idx) => (
                            <div key={idx} style={{ display: "flex", gap: "10px", marginTop: "8px", borderTop: idx > 0 ? "1px solid var(--border-glass)" : "none", paddingTop: idx > 0 ? "8px" : 0 }}>
                              ...
                              <div>
                                <p style={{ fontSize: "11px", color: "white" }}>{pr.description}</p>
                                <span style={{ fontSize: "9px", color: "var(--text-muted)" }}>{new Date(pr.date).toLocaleDateString()}</span>
                              </div>
                            </div>
                          ))}
                        </div>
          ...
          <section className="module-panel gsap-reveal">
            ...
            <div className="card-deck">
              {sosList.filter(s => s.status === "active").length === 0 ? (
                <p style={{ color: "var(--text-muted)", gridColumn: "1/-1", textAlign: "center", padding: "40px" }}>No active SOS alerts. Town is safe.</p>
              ) : (
                sosList.filter(s => s.status === "active").map(s => (
                  <div key={s.id} className="card sos-pulse-card" style={{ padding: "20px", display: "flex", flexDirection: "column", gap: "12px" }}>
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                      <span className="badge badge-pending" style={{ backgroundColor: "rgba(239, 68, 68, 0.15)", color: "var(--color-danger)", borderColor: "var(--color-danger)" }}>{s.severity} Severity</span>
                      <span style={{ fontSize: "11px", color: "var(--text-sub)" }}>{new Date(s.date).toLocaleTimeString()}</span>
                    </div>
                    <h4 style={{ color: "white" }}>{s.title}</h4>
                    <p style={{ fontSize: "13px", color: "var(--text-sub)", lineHeight: "1.5", flexGrow: 1 }}>{s.description}</p>
                    ...
                    {user?.role === "ngo" || user?.role === "volunteer" ? (
                      <button className="btn btn-teal" onClick={() => handleResolveSOSClick(s.id)} style={{ width: "100%" }}><Check size={14} /> Mark as Resolved</button>
                    ) : null}
                  </div>
                ))
              )}
        ...
        {activeView === "meds" && (
          <section className="module-panel gsap-reveal">
            <div className="content-header" style={{ padding: 0 }}>
              ...
              {user ? (
                <button className="btn btn-teal" onClick={() => setMedModal(true)}><Plus size={16} /> Donate Medicines</button>
              ) : (
            ...
            <div className="card-deck">
              {meds.filter(m => m.status === "available").length === 0 ? (
                <p style={{ color: "var(--text-muted)", gridColumn: "1/-1", textAlign: "center", padding: "40px" }}>No medicine pool coordinates currently registered.</p>
              ) : (
                  ...
                  <div key={m.id} className="card card-orange" style={{ padding: "20px", display: "flex", flexDirection: "column", justifyContent: "space-between", minHeight: "240px" }}>
                    <div>
                      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "8px" }}>
                        <h4 style={{ color: "white" }}>{m.medicineName}</h4>
                        <span className="badge badge-pending" style={{ backgroundColor: "rgba(0, 245, 212, 0.12)", color: "var(--color-teal)", borderColor: "rgba(0, 245, 212, 0.3)" }}>Available</span>
                      </div>
                    ...
                    {user?.role === "ngo" || user?.role === "volunteer" ? (
                      <button className="btn btn-orange" onClick={() => handleClaimMedClick(m.id)} style={{ width: "100%", marginTop: "15px" }}><Check size={14} /> Claim Medicine</button>
                    ) : null}
                  </div>
                ))
              )}
        ...
        {activeView === "rewards-store" && (
          <section className="module-panel gsap-reveal">
            <div className="content-header" style={{ padding: 0 }}>
              ...
              <div className="user-points-badge" style={{ fontSize: "14px", padding: "8px 16px" }}>
                <Award size={16} />
                <span>{user?.role === "volunteer" ? `${user.rewardPoints || 0} Pts Available` : "Guest Balance: 0 Pts"}</span>
              </div>
            </div>

            <div className="voucher-grid">
              {vouchers.length === 0 ? (
                <p style={{ color: "var(--text-muted)", gridColumn: "1/-1", textAlign: "center" }}>Loading rewards shelves...</p>
              ) : (
                vouchers.map(v => {
                  ...
                  return (
                    <div key={v.id} className="card voucher-card card-orange" style={{ padding: "20px" }}>
                      ...
                      <h4 style={{ color: "white" }}>{v.partner}</h4>
                      <span style={{ fontSize: "13px", color: "var(--text-sub)" }}>{v.title}</span>
                      <span className="voucher-cost">{v.pointsCost} Points</span>
                      <p style={{ fontSize: "11px", color: "var(--text-muted)", lineHeight: "1.4" }}>{v.description}</p>
                      
                      {user?.role === "volunteer" ? (
                        <button className="btn btn-orange" onClick={() => handleRedeemVoucherClick(v.id)} style={{ width: "100%" }} disabled={!hasPoints}>
            ...
            {/* Claimed vouchers log */}
            <div className="card card-orange" style={{ marginTop: "40px" }}>
              <h3>Redeemed Promo Codes</h3>
              <p style={{ color: "var(--text-sub)", fontSize: "13px", margin: "6px 0 20px 0" }}>Present these digital codes at partner checkouts to claim discounts.</p>
              
              <div className="leaderboard-list">
                {claims.filter(c => user && c.volunteerId === user.uid).length === 0 ? (
                  <p style={{ color: "var(--text-muted)", textAlign: "center", padding: "20px", fontStyle: "italic" }}>No redeemed vouchers recorded in history.</p>
                ) : (
                  claims.filter(c => user && c.volunteerId === user.uid).map(c => (
                    <div key={c.id} className="leaderboard-item">
                      <div className="leaderboard-item-info">
                        <div className="user-avatar" style={{ width: "34px", height: "34px", borderColor: "var(--color-orange)", color: "var(--color-orange)" }}>{c.partner.charAt(0)}</div>
                        <div>
                          <h5 style={{ fontSize: "13px" }}>{c.partner} - {c.voucherTitle}</h5>
                          <span style={{ fontSize: "10px", color: "var(--text-sub)" }}>Redeemed on {new Date(c.date).toLocaleDateString()}</span>
                        </div>
                      </div>
                      <span style={{ fontStyle: "normal", fontSize: "13px", fontWeight: "800", color: "var(--color-orange)", border: "1px dashed rgba(249,115,22,0.4)", padding: "4px 10px", borderRadius: "4px", background: "rgba(249,115,22,0.05)", userSelect: "all", cursor: "copy" }}>
                        {c.code}
                      </span>
                    </div>
                  ))
      ...
      <div className="toast-container">
        {toasts.map(t => (
          <div key={t.id} className={`toast ${t.isError ? "toast-error" : ""}`}>
            <Activity size={18} style={{ color: t.isError ? "var(--color-danger)" : "var(--color-teal)" }} />
            <span>{t.message}</span>
          </div>
        ))}
      </div>
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <form onSubmit={handleDriveCreateSubmit}>
                ...
                <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Plus size={14} /> Broadcast Campaign</button>
              </form>
            </div>
          </div>
        </div>
            ...
            <div className="modal-body">
              <form onSubmit={handleProofSubmit}>
                <div className="form-group">
                  ...
                  <p style={{ fontSize: "11px", color: "var(--text-muted)", marginTop: "4px" }}>Paste any online photo link to simulate uploading coordinates.</p>
                </div>
                <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Camera size={14} /> Submit Proof</button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <form onSubmit={handleFoodCompleteSubmit}>
                ...
                <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Check size={14} /> Confirm Completed</button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <form onSubmit={handleSkillCreateSubmit}>
                ...
                <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Plus size={14} /> Announce Task</button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <form onSubmit={handleSkillCompleteSubmit}>
                ...
                <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Check size={14} /> Submit Task</button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <form onSubmit={handleCrowdCreateSubmit}>
                ...
                <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Plus size={14} /> Publish Campaign</button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <form onSubmit={handleCrowdProofSubmit}>
                ...
                <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Camera size={14} /> Post Proof</button>
              </form>
            </div>
          </div>
        </div>
          ...
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              <form onSubmit={handleMedSubmit}>
                ...
                <button type="submit" className="btn btn-teal" style={{ width: "100%", marginTop: "10px" }}><Plus size={14} /> Donate to Medical Pool</button>
              </form>
            </div>
          </div>
        </div>
